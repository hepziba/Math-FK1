...
(function($, undefined) {
    ...
    // JQuery Support
    $.support.decompileFn = /xyz/.test(function() {
        var xyz;
    });
                ...
                from: function(obj, opts) {
                    return opts.format.replace(/(yyyy|yy|y|MMMM|MMM|MM|M|dddd|ddd|dd|d|HH|H|hh|h|mm|m|ss|s|t)/gi, function($1) {
                        switch ($1) {
                            ...
                            case 'yy':
                                return $iq.prepend0(obj.getFullYear() % 100, 2);
                            case 'y':
                                return (obj.getFullYear() % 100);
                            case 'MMMM':
                                return $iq.monthsLong[obj.getMonth()];
                            case 'MMM':
                                return $iq.monthsMedium[obj.getMonth()];
                            case 'MM':
                                return $iq.prepend0(obj.getMonth() + 1, 2);
                            case 'M':
                                return (obj.getMonth() + 1);
                            case 'dddd':
                                return $iq.daysLong[obj.getDay()];
                            case 'ddd':
                                return $iq.daysMedium[obj.getDay()];
                            case 'dd':
                                return $iq.prepend0(obj.getDate(), 2);
                            case 'd':
                                return obj.getDate();
                            case 'HH':
                                return $iq.prepend0(obj.getHours(), 2);
                            case 'H':
                                return obj.getHours();
                            case 'hh':
                                return $iq.prepend0((h = obj.getHours() % 12) ? h : 12, 2);
                            case 'h':
                                return ((h = obj.getHours() % 12) ? h : 12);
                            case 'mm':
                                return $iq.prepend0(obj.getMinutes(), 2);
                            case 'm':
                                return obj.getMinutes();
                            case 'ss':
                                return $iq.prepend0(obj.getSeconds(), 2);
                            case 's':
                                return obj.getSeconds();
                            case 't':
                                return obj.getHours() < 12 ? 'A.M.' : 'P.M.';
                        }
                        return retVal;
                    });
                }
    ...
    $iq.inherit = function(baseClass, childClass) {
        ...
        var basePrototype = $.isFunction(baseClass) ? baseClass.prototype : baseClass,
            ...
            _callBaseMethod = function(methodName) {
                ...
                return methodName ? basePrototype[methodName].apply(this, args) : baseClass.apply(this, args);
            },
    ...
    $iq.Plugin = $iqClass.extend({
        ...
        _trigger: function(eventType, event, data) {
            ...
            eventType = $.extend({}, instance._triggerOptions, (typeof eventType === "string" ? {
                type: eventType
            } : eventType));
...
(function($, undefined) {
    ...
    $.cookie = function(name, value, options) {
        ...
        // Set the cookie with the given name and value
            ...
            // Set the cookie
            return (document.cookie = [encodeURIComponent(name), '=', (options.raw ? value : encodeURIComponent(value)), // value
...
(function($, undefined) {
    ...
    $.fn.position = function(options) {
        ...
        if (options.disableFix !== true) {
            ...
            if ((options.fixed && (!$.support.fixedPosition || $this.css("position") != "fixed") && isWithinTarget) || options.autoPosition) {
...
(function($, undefined) {
    ...
    $iq.plugin("selectable", {
        ...
        _getMid: function($selectee) {
            ...
            return {
                x: selecteeData.left + (selecteeData.right - selecteeData.left) / 2,
        ...
        _select: function($selectees, event, selectOnOrOff, triggerMode) {
            ...
            $selectees.each(function() {
                ...
                if (triggerMode == 2 || instance._trigger(selecting, event, {
                        target: $selectee.addClass(selectingClass)[0]
                    })) {
                    if (triggerMode != 1) {
                        ...
                        instance._trigger(selected, event, {
                            target: $selectee[0]
                        });
                    }
                } else {
            ...
            for (var elemsCount = $boundElems.length; elemsCount--;) {
                ...
                while (propsCount--) {
                    ...
                    if (tempCssProp != cssProps[prop]) {
                        changedProps[prop] = {
                            oldValue: cssProps[prop],
                            newValue: tempCssProp
                        };
        ...
        _init: function() {
            ...
            $this.bind('mouseout', function(e) {
                ...
                if (options.enabled && $this.is(':visible')) {
                    ...
                    var iframe = $('.page').find('.pageContent')[0]
                    var iframeContentWindow = iframe.contentWindow;
                    $(".overlay").forwardMouseEvents();
                    t = $(iframeContentWindow.document.elementFromPoint(mx, my));
                    $this.show();
                    // console.log(lastT);
                    // t = lastT;  
                    // lastT = t;
                    ...
                    if (instance.movables.filter(extendedData.target).length) {
                        ...
                        $movables = instance.movables.each(function() {
                            var $elem = $(this),
                                ...
                                (parseInt($this.css("border-left-width")) || 0) + (parseInt($elem.css("marginLeft")) || 0) - (parseInt($elem.css('margin-left')) || 0);
                            minTop = $containerOffset.top - $elemOffset.top +
                                (parseInt($elem.css('top') == 'auto' && $elem.css('position') == 'absolute' ? $elem[0].offsetTop : $elem.css('top')) || 0) +
                                (parseInt($this.css("border-top-width")) || 0) + (parseInt($elem.css("marginTop")) || 0) - (parseInt($elem.css('margin-top')) || 0);
            ...
            if (domMoveOptions && domMoveOptions.enabled) {
                ...
                $this.dragstart(function(event, data) {
                    ...
                    if (domMoveOptions.enabled) {
                        ...
                        $movables = options.getMovingElements ? options.getMovingElements(event, {
                                target: data.target
                            }) :
                        ...
                        if ($movables.filter(data.target).length) {
                            ...
                            instance._trigger("moveInit", event, {
                                target: data.target
                            });
                            ...
                            instance._trigger("moveStart", event, {
...
(function($, undefined) {
    ...
    $iq.plugin("menu", {
        ...
        _click: function(event) {
            ...
            if (!hasLink || isArrow) {
                if (instance._trigger("clicking", event, {
                        target: domElem
                    })) {
                    instance._toggle($li, event);
                    instance._trigger("clicked", event, {
                        target: domElem
                    });
                }
            }
        ...
        _toggle: function($menu, event, toggleOn) {
            ...
            if (!options.triggerToggleEvents || instance._trigger(preEvent, event, {
                    target: $menu[0]
                })) {
                ...
                if (instance.options.triggerToggleEvents)
                    instance._trigger(postEvent, event, {
                        target: $menu[0]
                    });
            }
        },
        ...
        _initItem: function($li, noIcon) {
            var instance = this,
                ...
                $span, addArrow = instance.options.arrowAlways,
                hasChild,
...
(function($, undefined) {
    ...
    $iq.plugin("contextMenu", $.iq.menu, {
        ...
        _open: function(options) {
            ...
            $this.addClass(classes.opened).css({
                left: options.left,
                top: options.top,
                visibility: 'hidden'
            }).show();
                ...
                switch (e.which) {
                    ...
                    case keys.right:
                        if (instance.focusedItem) {
                            ...
                            setTimeout(function() {
                                $tempLi.find(">." + classes.item).addClass(classes.itemFocused);
                            }, 0);
                        }
                        break;
                    case keys.tab:
        ...
        _init: function() {
            ...
            instance._delegate($ul, "li", {
                click: function(event) {
                    ...
                    if (instance._trigger("selecting", event, {
                            target: domElem
                        })) {
            ...
            instance._$tabstrip1.tabstrip({
                ...
                selected: function(event, data) {
                    ...
                    instance._trigger("selected", event, {
                        target: data.target,
                        selectedIndex: selectedIndex,
                        tabPage: $multiview.find(">div:eq(" + selectedIndex + ")")
                    });
                }
            });
            ...
            instance._delegate($ul, "." + classes.itemAnchor, {
                ...
                click: function(event) {
                    ...
                    if (instance._trigger("selecting", event, {
                        ...
                        return instance._trigger("selected", event, {
                            target: $li[0]
                        });
                    }
                    return false;
...
(function($) {
    ...
    $iq.plugin("treeview", $iq.treeview, {
        ...
        _saveExpandedStateCookie: function() {
            ...
            $.cookie.set(cookieOptions.name, instance._expandedState, {
        ...
        _init: function() {
            ...
            if (cookieEnabled) {
                ...
                instance._expandedState = $.cookie.get(cookieOptions.name, {
                    type: 'json'
                });
            }
    ...
    $iq.plugin("button", {
        ...
        _init: function() {
            ...
            if ($this.is("input")) {
                ...
                width = $.trim($iq.curStyle($this, "width", {
                    hide: true
                }));
                if (/[\d]+%/.test(width)) {
    ...
    $iq.plugin("colorpicker", {
        ...
        _set: function(color, triggerEvent, updateCircle, updateTriangle) {
            ...
            if (colors.hex) {
                ...
                inputs.gradient.css("background-color", $iqColor.rgb2hex($iqColor.hsl2rgb({
                    h: hsl.h,
                    s: hsl.s,
                    l: 50
                })));
                ...
                if (triggerEvent) {
                    instance._trigger("changed", eventObj, {
                        newValue: colors,
                        oldValue: instance._color
                    });
                }
        ...
        _init: function() {
            ...
            inputs = instance._inputs = {
                rgbR: $this.find("." + classes.rgbR).restrictText({
                    filter: /^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])$/
                }),
                rgbG: $this.find("." + classes.rgbG).restrictText({
                    filter: /^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])$/
                }),
                rgbB: $this.find("." + classes.rgbB).restrictText({
                    filter: /^([01]?[0-9]?[0-9]|2[0-4][0-9]|25[0-5])$/
                }),

                hslH: $this.find("." + classes.hslH).restrictText({
                    filter: /^([012]?[0-9]?[0-9]|3[0-5][0-9])$/
                }),
                hslS: $this.find("." + classes.hslS).restrictText({
                    filter: /^([0]?[0-9]?[0-9]|100)$/
                }),
                hslL: $this.find("." + classes.hslL).restrictText({
                    filter: /^([0]?[0-9]?[0-9]|100)$/
                }),

                hsbH: $this.find("." + classes.hsbH).restrictText({
                    filter: /^([012]?[0-9]?[0-9]|3[0-5][0-9])$/
                }),
                hsbS: $this.find("." + classes.hsbS).restrictText({
                    filter: /^([0]?[0-9]?[0-9]|100)$/
                }),
                hsbB: $this.find("." + classes.hsbB).restrictText({
                    filter: /^([0]?[0-9]?[0-9]|100)$/
                }),

                hex: $this.find("." + classes.hex).restrictText({
                    filter: 'hex'
                }),
            ...
            $this.find("." + classes.select).click(function(event) {
                ...
                instance._trigger("select", event, {
                    selectedValue: instance._color
                });
            });
    ...
    sections = $iq.colorpicker.sections = {
        picker: {
            ...
            init: function($this, options) {
                var $colorNameSelect = $this.find("." + classes.colorNames),
                    optionsHtml = "";
        ...
        recent: {
            ...
            add: function($this, options, hex) {
                ...
                if ($.cookie && $.cookie.set) {
                    ...
                    $.cookie.set("iq-colorpicker-recent-list", colorList, {}, {
                        type: "json"
                    });
                }
            },
            init: function($this, options) {
                ...
                if ($.cookie && $.cookie.get) {
                    colorList = $.cookie.get("iq-colorpicker-recent-list", {}, {
                        type: "json"
                    });
                    if (colorList) {
    ...
    $iq.plugin("dialog", {
        ...
        _minimize: function() {
            ...
            $this.animate({
                width: "100px",
                height: height + "px",
                top: $(window).height() - height - ($this.outerHeight() - $this.height()),
                left: 0
...
(function($, undefined) {
    ...
    $iq.plugin("grid", {
        ...
        _editCell: function($td) {
            this._renderCell($td, $td.parent().prevAll().length, $td.prevAll().length, {
                mode: 'edit'
            });
        },
        _stopEdit: function() {
