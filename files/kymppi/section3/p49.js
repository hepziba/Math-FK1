...
(function(lib, img, cjs) {
    ...
    lib.properties = {
        ...
        manifest: [{
            ...
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section3/images/p49_1.png",
            id: "p49_2"
        }, {
    ...
    (lib.Symbol1 = function() {
        ...
        this.pageNum_text = new cjs.Text("49", "12px 'ElisarDTInfant-SemiBold'");
    ...
    (lib.Symbol2 = function() {
        ...
        this.text_1 = new cjs.Text("Jämför volym. Rita.", "17px 'ElisarDTInfant-Regular'");
        ...
        this.text_2 = new cjs.Text("RYMMER MINDRE", "15px 'Albus'", "#D03268");
        this.text_2.setTransform(50, 45);

        this.text_3 = new cjs.Text("JÄMFÖR MED", "15px 'Albus'", "#8DB93B");
        this.text_3.setTransform(215, 45);

        this.text_4 = new cjs.Text("RYMMER MER", "15px 'Albus'", "#31B1C9");
        this.text_4.setTransform(365, 45);

        this.instance_1 = new lib.p49_1();
        this.instance_1.setTransform(240, 80, 0.52, 0.52);

        this.instance_2 = new lib.p49_2();
        this.instance_2.setTransform(225, 217, 0.52, 0.52);

        this.instance_3 = new lib.p49_3();
        this.instance_3.setTransform(245, 355, 0.55, 0.55);
