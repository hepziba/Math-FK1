...
(function(lib, img, cjs) {
    ...
    lib.properties = {
        ...
        color: "#FFFFFF",
        manifest: [{
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_1.png",
            id: "p64_1"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_2.png",
            id: "p64_2"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_3.png",
            id: "p64_3"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_4.png",
            id: "p64_4"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_5.png",
            id: "p64_5"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_6.png",
            id: "p64_6"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_7.png",
            id: "p64_7"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_8.png",
            id: "p64_8"
        }, {
            src: "https://majemastoragetest.blob.core.windows.net/math-test/FK1/files/kymppi/section4/images/p64_9.png",
            id: "p64_9"
        }, {
    ...
    (lib.p64_4 = function() {
        this.initialize(img.p64_4);
    }).prototype = p = new cjs.Bitmap();
    p.virtualBounds = new cjs.Rectangle(0, 0, 633, 542);

    (lib.p64_5 = function() {
        this.initialize(img.p64_5);
    }).prototype = p = new cjs.Bitmap();
    p.virtualBounds = new cjs.Rectangle(0, 0, 633, 542);

    (lib.p64_6 = function() {
        this.initialize(img.p64_6);
    }).prototype = p = new cjs.Bitmap();
    p.virtualBounds = new cjs.Rectangle(0, 0, 350, 350);

    (lib.p64_7 = function() {
        this.initialize(img.p64_7);
    }).prototype = p = new cjs.Bitmap();
    p.virtualBounds = new cjs.Rectangle(0, 0, 633, 542);

    (lib.p64_8 = function() {
        this.initialize(img.p64_8);
    }).prototype = p = new cjs.Bitmap();
    p.virtualBounds = new cjs.Rectangle(0, 0, 633, 542);

    (lib.p64_9 = function() {
        this.initialize(img.p64_9);
    }).prototype = p = new cjs.Bitmap();
    p.virtualBounds = new cjs.Rectangle(0, 0, 350, 350);
    ...
    (lib.Symbol1 = function() {
        ...
        this.pageNum_text = new cjs.Text("64", "12px 'ElisarDTInfant-SemiBold'");
        this.pageNum_text.setTransform(75, 665);

        this.pageBottomText = new cjs.Text("Räknehändelser subtraktion", "9.5px 'ElisarDTInfant-SemiBold'");
    ...
    (lib.Symbol2 = function() {
        ...
        this.instance_1 = new lib.p64_1();
        this.instance_1.setTransform(40, 50, 0.45, 0.45);

        this.instance_2 = new lib.p64_2();
        this.instance_2.setTransform(232, 34, 0.52, 0.52);

        this.instance_3 = new lib.p64_3();
        this.instance_3.setTransform(352, 45, 0.5, 0.5);
    ...
    (lib.Symbol3 = function() {
        ...
        this.instance_1 = new lib.p64_4();
        this.instance_1.setTransform(48, 18, 0.5, 0.5);

        this.instance_2 = new lib.p64_5();
        this.instance_2.setTransform(198, 28, 0.57, 0.57);

        this.instance_3 = new lib.p64_6();
        this.instance_3.setTransform(363, 43, 0.52, 0.52);
    ...
    (lib.Symbol4 = function() {
        ...
        this.instance_1 = new lib.p64_7();
        this.instance_1.setTransform(39, 35, 0.55, 0.55);

        this.instance_2 = new lib.p64_8();
        this.instance_2.setTransform(215, 40, 0.55, 0.55);

        this.instance_3 = new lib.p64_9();
        this.instance_3.setTransform(347, 35, 0.55, 0.55);

        this.addChild(this.instance_1, this.instance_2, this.instance_3);

    }).prototype = p = new cjs.Container();
    p.virtualBounds = new cjs.Rectangle(0, 0, 490, 210);
